...
{
    NSURL *urlToTest = [[NSURL alloc] initWithString:@"https://2ch.pm/mobi/"];
...
{
    NSURL *urlToTest = [[NSURL alloc] initWithString:@"https://2ch.pm/mobi/res/531218.html"];
    UrlNinja *url = [[UrlNinja alloc] initWithUrl:urlToTest];
...
{
    NSURL *urlToTest = [[NSURL alloc] initWithString:@"https://2ch.pm/mobi/res/472567.html#532581"];
    UrlNinja *url = [[UrlNinja alloc] initWithUrl:urlToTest];
