...
#define COCOAPODS_VERSION_MINOR_YapDatabase 7
...
#define COCOAPODS_VERSION_MINOR_YapDatabase_standard 7
#define COCOAPODS_VERSION_PATCH_YapDatabase_standard 0
